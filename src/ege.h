...
void EGEAPI fillcircle(int x, int y, int radius, PIMAGE pimg = NULL) { fillellipse(x,y,radius,radius); }   //画填充圆
...
void EGEAPI fillcirclef(float x, float y, float radius, PIMAGE pimg = NULL) { fillellipsef(x,y,radius,radius); }   //画填充圆
